...
FRAMEWORK_API int run(Framework* framework)
{
...

	{
        ...
        while ( ! done ) {
		   ...
		   //SDL_SetRenderDrawColor(g_renderer, 0x0, 0x0, 0x0, 0x0);
		   //SDL_SetRenderDrawColor(g_renderer, 0xA0, 0xA0, 0xA0, 0xFF);
		   SDL_SetRenderDrawColor(g_renderer, BACKGROUND_COLOR.r, BACKGROUND_COLOR.g, BACKGROUND_COLOR.b, BACKGROUND_COLOR.a);
			SDL_RenderClear(g_renderer);
